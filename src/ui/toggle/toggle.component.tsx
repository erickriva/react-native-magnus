        ...
        style={[
          computedStyle.container,
          {
            backgroundColor: animXValue.interpolate({
              inputRange: [0, 1],
              outputRange: [
                getThemeColor(theme.values.colors, bg),
                getThemeColor(theme.values.colors, activeBg),
              ],
            }),
          },
        ]}
          ...
          style={[
            computedStyle.circle,
            {
              backgroundColor: animXValue.interpolate({
                inputRange: [0, 1],
                outputRange: [
                  getThemeColor(theme.values.colors, circleBg),
                  getThemeColor(theme.values.colors, activeCircleBg),
                ],
              }),
            },
            {
